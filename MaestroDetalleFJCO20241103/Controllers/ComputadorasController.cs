...
namespace MaestroDetalleFJCO20241103.Controllers
{
    public class ComputadorasController : Controller
    {
        ...
        public ComputadorasController(MaestroDetalleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Computadoras != null ? 
                          ...
                          Problem("Entity set 'MaestroDetalleContext.Computadoras'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MaestroDetalleContext.Computadoras'  is null.");
            }
            var computadora = await _context.Computadoras.FindAsync(id);
            if (computadora != null)
            {
